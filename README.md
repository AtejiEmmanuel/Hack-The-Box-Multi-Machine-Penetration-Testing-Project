...
Full reference list available in the [report document](https://github.com/AtejiEmmanuel/Hack-The-Box-Multi-Machine-Penetration-Testing-Project/blob/main/Hack-The-Box-Multi-Machine-Penetration-Testing-Project-Report.pdf).
